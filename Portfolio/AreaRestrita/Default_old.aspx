<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default_old.aspx.cs" Inherits="Portfolio.AreaRestrita.Default" %>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <%--<span>Samuel</span> --%>
                                <span>
                                    <asp:Label ID="lblUsuarioLogado" runat="server" Text="Usuario"></asp:Label>
                                </span>
							...
							<ul class="dropdown-menu">
                                ...
                                <%--<asp:LinkButton ID="lkbLogout" runat="server" OnClick="lkbLogout_Click">
                                    <li><a href="#"><i class="lnr lnr-exit"></i> <span>Logout</span></a></li>
                                </asp:LinkButton>--%>
                                <%--<li>
                                    <a href="#"><i class="lnr lnr-exit"></i> 
                                        <span>
                                            <asp:LinkButton ID="lkbLogout" runat="server" OnClick="lkbLogout_Click" Text="Logout"></asp:LinkButton>
